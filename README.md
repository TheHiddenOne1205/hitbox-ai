...
sequenceDiagram
    autonumber
    Designer->>Hitbox: Uploads draft GDD or defines game tokens (genre, platform, style)
    Hitbox->>AI Engine: Parses core features and structures mechanics targets
    Hitbox->>Web Crawler: Dispatches SearXNG to audit Steam & Reddit footprint
    Web Crawler->>Hitbox: Returns raw player sentiment discussions
    Hitbox->>Scraper Agent: Launches stealth browser to crawl competitor wikis/forums
    Scraper Agent->>Hitbox: Extracts mechanical balance data and design pitfalls
    Hitbox->>Designer: Displays structured alignment score & exports Pitch PDF!
```
